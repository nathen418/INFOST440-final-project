...
?>
        <form style="margin-top:2rem" action=<?php echo "comments.php?blogpost_id=" . $blogid; ?> method="post">
            ...
            <div class="form-outline form-white mb-4">
                <textarea name="comment" id="comment" class="form-control form-control-lg" maxlength="1024"><?php 
...
while ($row = mysqli_fetch_array($commentResult, MYSQLI_ASSOC)) {
    ?>
        <div class="card bg-dark text-white">
            <div class="card-body">
<?php
    if (isset($_SESSION['user_id']) && isset($updateid) && $row['comment_id'] == $updateid && 
...
?>
            <h5 class="card-title"><?php echo $row['first_name']; if ($row['is_admin'] == 1) echo '  <span style="color: red;">(Admin)</span>'; ?></h5>
